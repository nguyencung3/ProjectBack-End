 ...
 * @author CungNguyen
 */
public class Tbl_OrderDetaillDAO implements Serializable {

    public boolean insertNewOrder(int orderId, String userId, String mobileId, int quantity) throws SQLException, NamingException {
        Connection con = null;
