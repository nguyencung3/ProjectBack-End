...
public class DeleteUserServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (result) {
                urlRewriting = "ProcessServlet?btAction=Search"
                        + "&txtSearchValueByAdmin="
                        + searchValue;
            } else {
                request.setAttribute("ERRORPAGE", "DeleteUserServlet Occur Error");
            }
        } catch (ClassNotFoundException ex) {
            log("DeleteUserServlet _ ClassNotFound" + ex.getMessage());
