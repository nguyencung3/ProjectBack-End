...
public class Tbl_MobileDAO implements Serializable {
    ...
    public void SearchDeviceByIDOrName(String searchValue) throws NamingException, SQLException {
        Connection con = null;
    ...
    public void SearchDeviceByRange(float max, float min) throws NamingException, SQLException {
        Connection con = null;
        PreparedStatement stm = null;
        ResultSet rs = null;
        if (max < min) {
        ...
        try {
            con = DBConnection.MakeConnection();
            if (con != null) {
                String sql = "Select * From tbl_Mobile Where price>= ? And price<= ? And quantity > 0";
                stm = con.prepareStatement(sql);
                stm.setFloat(1, min);
                stm.setFloat(2, max);
                rs = stm.executeQuery();
    ...
    public boolean DeleteRecord(String primaryKey) throws NamingException, SQLException {
        Connection con = null;
        PreparedStatement stm = null;
        try {
            con = DBConnection.MakeConnection();
    ...
    public boolean updateRecord(String mobileID, int quantity) throws NamingException, SQLException {
        Connection con = null;
        PreparedStatement stm = null;
        try {
            con = DBConnection.MakeConnection();
    ...
    public boolean updateRecord(String mobileID, String description, float price, int quantity, boolean notsale) throws NamingException, SQLException {
        Connection con = null;
        PreparedStatement stm = null;
        try {
            con = DBConnection.MakeConnection();
    ...
    public boolean insertNewMobile(String mobileID, String description, float price, String mobileName, int year, int quantity, boolean notSale) throws NamingException, SQLException {
        Connection con = null;
        PreparedStatement stm = null;
        try {
            con = DBConnection.MakeConnection();
    ...
    public int getQuantityProduct(String idMobile) throws NamingException, SQLException {
        Connection con = null;
        PreparedStatement stm = null;
        ResultSet rs = null;
        try {
