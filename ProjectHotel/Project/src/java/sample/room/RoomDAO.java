...
public class RoomDAO implements Serializable {
    ...
    private List<RoomDTO> listRoomsMaintance;
    private List<RoomDTO> listRoomsInfo;

    public List<RoomDTO> getListRoomsInfo() {
        return listRoomsInfo;
    }

    public List<RoomDTO> getListRoomsMaintance() {
            ...
            if (con != null) {
                ...
                while (rs.next()) {
                    ...
                    if (listRoomsMaintance == null) {
                        listRoomsMaintance = new ArrayList<RoomDTO>();
                    }
                    RoomDTO dto = new RoomDTO(roomId, reason);
        ...
        try {
            ...
            if (con != null) {
                ...
                while (rs.next()) {
                    ...
                    RoomDTO dto = new RoomDTO(roomID, description, hourPrice, dayPrice);
                    if (listRoomsInfo == null) {
                        listRoomsInfo = new ArrayList<RoomDTO>();
                    }
